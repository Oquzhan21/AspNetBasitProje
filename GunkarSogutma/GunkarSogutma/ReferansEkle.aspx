<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ReferansEkle.aspx.cs" Inherits="GunkarSogutma.ReferansEkle" %>
    ...
    <div style="margin-bottom: 110px" class="container">
        <div class="row">
            <form id="form1" runat="server">
                ...
                Referans Adı: 
                <asp:TextBox ID="TextBox1" CssClass="txtAdi" runat="server"></asp:TextBox>
                <asp:Button ID="Button1" runat="server" Text="Yükle" OnClick="Button1_Click" />
                <br />
                <table>
                <asp:Repeater runat="server" ID="Repeater1">
                    <ItemTemplate>
                <div style="float:left;margin-bottom:10px">  <asp:Image ID="Image1"  Width="200px" Height="200px" runat="server" ImageUrl='<%#Eval("ReferansFotosu") %>' />
                <div style="float:left;width:150px;height:150px;text-align:center;line-height:150px;margin-left:-7px;margin-right:-7px"><span><%#Eval("ReferansAdı") %></span></div></div>
                    </ItemTemplate>
                </asp:Repeater>
                    </table>
                
                <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:GunkarSogutmaConnectionString9 %>" ProviderName="System.Data.SqlClient" SelectCommand="SELECT [ReferansFotosu], [ReferansAdı] FROM [GReferans]"></asp:SqlDataSource>
