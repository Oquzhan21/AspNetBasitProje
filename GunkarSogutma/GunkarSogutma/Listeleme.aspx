<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Listeleme.aspx.cs" Inherits="GunkarSogutma.Listeleme" %>
      ...
      <div style="margin-bottom: 110px" class="container">
          <div class="row">
              <form id="form1" runat="server">
                  Ürün Adı:<asp:TextBox ID="TextBox1" runat="server"></asp:TextBox><br />
                 Kategoriler: <asp:DropDownList ID="DropDownList1" runat="server" DataSourceID="SqlDataSource3" DataTextField="KategoriAdi" DataValueField="kategoriId"></asp:DropDownList>
                  <asp:SqlDataSource ID="SqlDataSource3" runat="server" ConnectionString="<%$ ConnectionStrings:GunkarSogutmaConnectionString10 %>" SelectCommand="SELECT [kategoriId], [KategoriAdi], [KategoriResim] FROM [GKategoriler]"></asp:SqlDataSource>
            ...
            <asp:ListView ID="ListView1" runat="server" DataSourceID="SqlDataSource2">
                <ItemTemplate>
                    <li>
                        ...
                        <a  href='<%# "Listeleme.aspx?urun="+Eval("kategoriId") %>''>
