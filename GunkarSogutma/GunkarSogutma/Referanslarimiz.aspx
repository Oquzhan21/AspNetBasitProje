<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Referanslarimiz.aspx.cs" Inherits="GunkarSogutma.Referanslarimiz" %>
            ...
            <center>
              <div class="col-lg-12 col-md-12 col-xs-12 col-sm-12">
                  <asp:Repeater ID="Repeater1" runat="server">
                     <ItemTemplate>
                        <div style="float:left;margin-bottom:10px">  <asp:Image ID="Image1" Width="400px" Height="200px" runat="server" ImageUrl='<%#Eval("ReferansFotosu") %>' />
                  ...
                  <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:GunkarSogutmaConnectionString8 %>" SelectCommand="SELECT [ReferansFotosu],[ReferansAdı] FROM [GReferans]"></asp:SqlDataSource>
              </div>
              </center>
        </div>
    </div>
